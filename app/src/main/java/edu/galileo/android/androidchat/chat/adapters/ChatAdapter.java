...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.EditTxtMessage.setText(msg);
        ...
        holder.EditTxtMessage.setBackgroundColor(color);
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) holder.EditTxtMessage.getLayoutParams();
        params.gravity = gravity;
        holder.EditTxtMessage.setLayoutParams(params);
    }
