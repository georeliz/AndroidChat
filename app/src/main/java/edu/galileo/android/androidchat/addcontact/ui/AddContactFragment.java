...
public class AddContactFragment extends DialogFragment implements AddContactView, DialogInterface.OnShowListener {
   ...
   AddContactPresenter  presenter;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity()).setTitle(R.string.addcontact_message_title).setPositiveButton(R.string.addcontact_message_add, new DialogInterface.OnClickListener() {
    ...
    public void onShow(DialogInterface dialogInterface) {
        ...
        if (dialog != null){
            Button postiveButton = dialog.getButton(Dialog.BUTTON_POSITIVE);
